<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CreateAcc.aspx.vb" Inherits="Tamagotchi.CreateAcc" %>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:Button Text="Create Account" runat="server" type="submit" name="login-submit" ID="button1" class="form-control btn btn-primary" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
